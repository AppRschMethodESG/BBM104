...
# Run this chunk once to set up the R environment
...
#system("sudo apt-get install libharfbuzz-dev")
#system("sudo apt-get install libfribidi-dev")
...
required_packages <- c('languageserver', 'curl', 'mime', 'fansi', 'pkgconfig', 'sys')
...
required_packages <- c('askpass', 'openssl', 'utf8', 'pillar', 'httr', 'selectr', 'tibble', 'rvest', 'remotes')
exact_files <- c('askpass_1.2.1.tar.gz', 'openssl_2.3.2.tar.gz', 'utf8_1.2.4.tar.gz', 'pillar_1.10.1.tar.gz', 'httr_1.4.7.tar.gz', 'selectr_0.4-2.tar.gz', 'tibble_3.2.1.tar.gz', 'rvest_1.0.4.tar.gz', 'remotes_2.5.0.tar.gz')
