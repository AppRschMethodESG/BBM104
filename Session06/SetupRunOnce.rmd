...
# Save the required packages into a vector of strings
required_packages <- c("bit", "fastmap", "rappdirs", "gargle", "uuid", "cachem", "htmltools", "viridisLite", 
"colorspace", "xfun", "ps", "processx", "sass", "rappdirs", "base64enc", 
                        "farver", "labeling", "munsell", "RColorBrewer", "bit64",
                        "rematch", "memoise", "blob", "DBI", "gtable", "isoband", "scales",
                       "googledrive", "ids", "rematch2", "prettyunits"
...
required_packages <- c(
                       ...
                       "systemfonts", "textshaping", "clipr", "crayon", 
