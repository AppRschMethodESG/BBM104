...
#system("wget https://cran.r-project.org/src/contrib/ps_1.9.0.tar.gz")
#install.packages("ps_1.9.0.tar.gz", repos = NULL, type = "source", dependencies = TRUE)
#system("wget https://cran.r-project.org/src/contrib/processx_3.8.5.tar.gz")
#install.packages("processx_3.8.5.tar.gz", repos = NULL, type = "source", dependencies = TRUE)
...
#/usr/bin/R --silent --slave --no-save --no-restore -e "install.packages('languageserver', repos='https://cloud.r-project.org/', dependencies=TRUE, lib='/workspaces/BBM104/R_Library')"
...
# Install more required packages and rvest
required_packages <- c('askpass', 'openssl', 'utf8', 'pillar', 'httr', 'selectr', 'tibble', 'rvest')
exact_files <- c('askpass_1.2.1.tar.gz', 'openssl_2.3.2.tar.gz', 'utf8_1.2.4.tar.gz', 'pillar_1.10.1.tar.gz', 'httr_1.4.7.tar.gz', 'selectr_0.4-2.tar.gz', 'tibble_3.2.1.tar.gz', 'rvest_1.0.4.tar.gz')
...
required_packages <- c("bit", "sass", "rappdirs", "base64enc", "fastmap", "cachem", 
