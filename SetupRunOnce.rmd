...
#install.packages('languageserver')  #‘processx.so’ not found
...
required_packages <- c("digest", "colorspace", 'cli', #'glue', 'stringi', 'rlang', 
...
exact_files <- c()
# Save the required packages into a vector of strings
required_packages <- c("bit", "fastmap", "rappdirs", "uuid", "htmltools", "viridisLite", #"colorspace", 
"xfun", "base64enc", 
                        "farver", "labeling", "munsell", "RColorBrewer", 
                        "rematch", "blob", "DBI", "gtable", "isoband", 
                       "rematch2", "prettyunits", "processx", "sass",
                       )
# Collect the list of .tar.gz files from the webpage
url <- "https://cran.r-project.org/src/contrib/"
page <- rvest::read_html(url)
...
required_packages <- c( 
  "bit64", "cachem", "ids", "memoise", "scales",
                       ...
                       "rematch2", "prettyunits", "readr", "timechange", "lubridate", 
                       "ggplot2", "tidyverse",
